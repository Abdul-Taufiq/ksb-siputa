...
class BantuanTSIController extends Controller
{
    ...
    private $subjek = 'Pengajuan Bantuan TSI';
    private $subjek_status = 'Status | Pengajuan Bantuan TSI';
    ...
    public function ResponApprove(Request $request, $idEncrypt)
    {
        ...
        switch ($jabatan) {
            ...
            case 'SDM':
                ...
                $this->emailServices->SendEmailToUserLain($data, $userPenerima, $url, $title, $message, $this->subjek);
                break;

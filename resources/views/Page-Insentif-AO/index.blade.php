                        ...
                        <div class="card card-outline card-primary">
                            <div class="card-header">
                                @can('UserCreate', App\Models\User\EmailPe::class)
                                    <a class="btn btn-primary btn-icon-split btn-sm" href="{{ route('ao.create') }}">
                                ...
                                <table id="table_index" class="table table-hover table-striped table-bordered table-sm"
                                    ...
                                    <thead style="background-color: lightseagreen">
                                        <tr>
                                            ...
                                            <th style="width: 10%">K.Cabang</th>
                                            <th style="width: 20%">Nama AO</th>
                                            <th style="width: 25%">Data Target</th>
...
@section('script')
    <script src="{{ asset('insentif_js/ao_index.js') }}"></script>
@endsection
@endsection

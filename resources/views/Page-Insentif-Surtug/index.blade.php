...
@section('konten')
    ...
    <div class="content-wrapper">
                        ...
                        <div class="card card-outline card-primary">
                            <div class="card-header">
                                @can('UserCreate', App\Models\User\EmailPe::class)
                                    <a class="btn btn-primary btn-icon-split btn-sm" href="{{ route('surtug.create') }}">
        ...
        {{-- Modal --}}
        @include('Page-Insentif-Surtug.modal')
        {{-- end modal --}}
...
@section('script')
    <script src="{{ asset('insentif_js/surtug_index.js') }}"></script>
@endsection
@endsection

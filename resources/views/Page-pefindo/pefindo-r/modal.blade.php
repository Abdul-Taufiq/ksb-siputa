...
<div class="modal fade" id="addModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-lg">
        <form id="quickForm" action="{{ url('pefindo-reset') }}" method="post" enctype="multipart/form-data">
            @csrf
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="keperluan" id="keperluan" autocomplete="off" required
                                            ...
                                            <option value="Reset Password User"
                                                {{ old('keperluan') == 'Reset Password User' ? 'selected' : null }}>
                                                Reset Password User</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6">

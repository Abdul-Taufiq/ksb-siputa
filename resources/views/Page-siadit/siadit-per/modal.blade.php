...
<div class="modal fade" id="addModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-lg">
        <form id="quickForm" action="{{ url('siadit-perubahan') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="add" style="letter-spacing: 2px; font-weight: bold;">
                        Pengajuan Perubahan Data Si-Adit
                    </h5>
                    ...
                    <div class="card card-outline card-primary">
                        <div class="card-body">
                            <div class="row ml-2">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="keperluan" id="keperluan" autocomplete="off" required
                                            ...
                                            <option value="Perubahan Data SPK"
                                                {{ old('keperluan') == 'Perubahan Data SPK' ? 'selected' : null }}>
                                                Perubahan Data SPK
                                            </option>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="no_spk">No SPK (Nomor SPK) :</label>
                                        <input type="text" name="no_spk" id="no_spk" required
                                            class="form-control input" placeholder="No SPK (Nomor SPK)">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama_nasabah" id="nama_nasabah"
                                            class="form-control input" placeholder="Nama Nasabah" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="user">User Pelaku Kesalahan :</label>
                                        <input type="text" name="user" id="user" class="form-control input"
                                            placeholder="User Pelaku Kesalahan" required>
                                    </div>
                                </div>

                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="data_salah">Data Salah :</label>
                                        <textarea class="form-control input" name="data_salah" id="data_salah" cols="30" rows="3" required
                                            placeholder="Sata Salah"></textarea>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="pembetulan">Data Pembetulan :</label>
                                        <textarea class="form-control input" name="pembetulan" id="pembetulan" cols="30" rows="3" required
                                            placeholder="Data Pembetulan"></textarea>
                                    </div>
                                </div>
                ...
                <div class="card card-outline card-primary">
                    <div class="card-body">
                        <div class="row ml-2">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="keperluan_edit">Keperluan :</label>
                                    <select name="keperluan_edit" id="keperluan_edit" autocomplete="off" required
                                        class="form-control input">
                                        <option disabled selected hidden>- Pilih Keperluan -</option>
                                        <option value="Perubahan Data SPK"
                                            {{ old('keperluan') == 'Perubahan Data SPK' ? 'selected' : null }}>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="no_spk_edit">No SPK (Nomor SPK) :</label>
                                    <input type="text" name="no_spk_edit" id="no_spk_edit" required
                                        class="form-control input" placeholder="No SPK (Nomor SPK)">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="nama_nasabah_edit">Nama Nasabah :</label>
                                    <input type="text" name="nama_nasabah_edit" id="nama_nasabah_edit"
                                        class="form-control input" placeholder="Nama Nasabah" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="user_edit">User Pelaku Kesalahan :</label>
                                    <input type="text" name="user_edit" id="user_edit" class="form-control input"
                                        placeholder="User Pelaku Kesalahan" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="data_salah_edit">Data Salah :</label>
                                    <textarea class="form-control input" name="data_salah_edit" id="data_salah_edit" cols="30" rows="3"
                                        required placeholder="Sata Salah"></textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="pembetulan_edit">Data Pembetulan :</label>
                                    <textarea class="form-control input" name="pembetulan_edit" id="pembetulan_edit" cols="30" rows="3"
                                        required placeholder="Data Pembetulan"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control input" name="keterangan_edit" id="keterangan_edit" cols="30" rows="3"
                                        required placeholder="Keterangan"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>

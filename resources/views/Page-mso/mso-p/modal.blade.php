...
<div class="modal fade" id="addModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-lg">
        <form id="quickForm" action="{{ url('mso-pengajuan') }}" method="post" enctype="multipart/form-data">
            @csrf
                ...
                <div class="modal-body">
                    <div class="card card-outline card-primary">
                        <div class="card-body">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="keperluan" id="keperluan" autocomplete="off" required
                                            ...
                                            <option value="Permohonan User Baru (Alternate)"
                                                {{ old('keperluan') == 'Permohonan User Baru (Alternate)' ? 'selected' : null }}>
                                                Permohonan User Baru (Alternate)</option>
                            ...
                            <div class="row ml-2 d-none" id="masa_aktif">
                                <h5>Masa Aktif</h5>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="tgl_awal">Tanggal Awal :</label>
                                        <input type="date" name="tgl_awal" id="tgl_awal" class="form-control input">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                ...
                <div class="modal-body">
                    <div class="card card-outline card-primary">
                        <div class="card-body">
                            ...
                            <div class="row ml-2 d-none" id="masa_aktif_edit">
                                <h5>Masa Aktif</h5>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="tgl_awal">Tanggal Awal :</label>

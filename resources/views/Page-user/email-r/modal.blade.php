...
<div class="modal fade" id="addModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-lg">
        <form id="quickForm" action="{{ url('user-email-reset') }}" method="post" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="card card-outline card-primary">
                        <div class="card-body">
                            <div class="row ml-2">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="keperluan" id="keperluan" autocomplete="off" required
                                            ...
                                            <option value="Lupa Password"
                                                {{ old('keperluan') == 'Lupa Password' ? 'selected' : null }}>
                                                Lupa Password
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="user">User/Email (yang ingin direset pass) :</label>
                                        <input type="email" name="user" id="user" class="form-control input"
                                            placeholder="Email Yang ingin direset" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                    ...
                    <div class="card card-outline card-primary">
                        <div class="card-body">
                            <div class="row ml-2">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="user_edit">User/Email (yang ingin direset pass) :</label>
                                        <input type="email" name="user" id="user_edit"
                                            class="form-control input" placeholder="Email Yang ingin direset"
                                            required>
                                    </div>
                                </div>
                                <div class="col-md-6">

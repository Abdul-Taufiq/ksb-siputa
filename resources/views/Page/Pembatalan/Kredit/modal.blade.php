...
<div class="modal fade" id="addModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-lg">
        <form id="quickForm" action="{{ url('pembatalan-kredit') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="add" style="letter-spacing: 2px; font-weight: bold;">
                        Tambah Pengajuan Pembatalan Transaksi Kredit
                    </h5>
                            ...
                            <div class="row ml-2">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="jns_kredit">Jenis Transaksi Kredit :</label>
                                        <select name="jns_kredit" id="jns_kredit" autocomplete="off" required
                                            class="form-control input">
                                            <option value="" disabled selected>- Pilih Jenis Transaksi Kredit -
                                            </option>
                                            <option value="Transaksi Manual Kredit"
                                                {{ old('jns_kredit') == 'Transaksi Manual Kredit' ? 'selected' : null }}>
                                                Transaksi Manual Kredit</option>
                                            <option value="Transaksi Autodebet Kredit"
                                                {{ old('jns_kredit') == 'Transaksi Autodebet Kredit' ? 'selected' : null }}>
                                                Transaksi Autodebet Kredit</option>
                                ...
                                <div class="col-md-6 d-none" id="keterangan_jns_kredit_head">
                                    <div class="form-group">
                                        <label for="keterangan_jns_kredit">Keterangan Jenis Kredit :</label>
                        ...
                        <div class="card-body">
                            <div class="row ml-2">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="jns_kredit">Jenis Transaksi Kredit :</label>
                                        <select name="jns_kredit" id="jns_kredit_edit" autocomplete="off" required
                                            class="form-control input">
                                            <option value="" disabled selected>- Pilih Jenis Transaksi Kredit -
                                            </option>
                                            <option value="Transaksi Manual Kredit"
                                ...
                                <div class="col-md-6 d-none" id="keterangan_jns_kredit_head_edit">
                                    <div class="form-group">
                                        <label for="keterangan_jns_kredit">Keterangan Jenis Kredit :</label>
                                ...
                                <div class="col-md-6" id="user_head_edit">
                                    <div class="form-group">
                                        <label for="user">User :</label>

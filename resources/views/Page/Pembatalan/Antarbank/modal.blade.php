...
<div class="modal fade" id="addModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-lg">
        <form id="quickForm" action="{{ url('pembatalan-antarbank') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="add" style="letter-spacing: 2px; font-weight: bold;">
                        Tambah Pengajuan Pembatalan Transaksi Antar Bank
                    </h5>
                            ...
                            <div class="row ml-2">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="nama_bank" id="nama_bank" autocomplete="off" required
                                            class="form-control input">
                                            <option value="" disabled selected hidden>- Pilih Nama Bank -
                                            </option>
                                            <option value="BANK BRI"
                                                {{ old('nama_bank') == 'BANK BRI' ? 'selected' : null }}>
                                                BANK BRI</option>
                                            <option value="BANK BNI"
                                                {{ old('nama_bank') == 'BANK BNI' ? 'selected' : null }}>
                                                BANK BNI</option>
                                            <option value="BANK BCA"
                                                {{ old('nama_bank') == 'BANK BCA' ? 'selected' : null }}>
                                                BANK BCA</option>
                                            <option value="BANK BTN"
                                                {{ old('nama_bank') == 'BANK BTN' ? 'selected' : null }}>
                                                BANK BTN</option>
                                            <option value="BANK MANDIRI"
                                                {{ old('nama_bank') == 'BANK MANDIRI' ? 'selected' : null }}>
                                                BANK MANDIRI</option>
                                            <option value="BANK DANAMON"
                                                {{ old('nama_bank') == 'BANK DANAMON' ? 'selected' : null }}>
                                                BANK DANAMON</option>
                                            <option value="BANK BPD JATENG"
                                                {{ old('nama_bank') == 'BANK BPD JATENG' ? 'selected' : null }}>
                                                BANK BPD JATENG</option>
                                            <option value="BANK MASPION"
                                                {{ old('nama_bank') == 'BANK MASPION' ? 'selected' : null }}>
                                                BANK MASPION</option>
                                        </select>
                                    </div>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="row ml-2">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="nama_bank">Nama Bank :</label>
                                        <select name="nama_bank" id="nama_bank_edit" autocomplete="off" required
                                            class="form-control input">
                                            <option value="" disabled selected hidden>- Pilih Nama Bank -
                                            </option>
                                            <option value="BANK BRI"

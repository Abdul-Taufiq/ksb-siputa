...
<div class="modal fade" id="addModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-lg">
        <form id="quickForm" action="{{ url('pembatalan-akuntansi') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="add" style="letter-spacing: 2px; font-weight: bold;">
                        Tambah Pengajuan Pembatalan Transaksi Akuntansi
                    </h5>
                            ...
                            <div class="row ml-2">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="jns_akuntansi">Jenis Akuntansi :</label>
                                        <select name="jns_akuntansi" id="jns_akuntansi" autocomplete="off" required
                                            class="form-control input">
                                            <option disabled selected hidden>- Pilih Jenis Akuntansi -</option>
                                            <option value="Transaksi Jurnal Kas"
                                                {{ old('jns_akuntansi') == 'Transaksi Jurnal Kas' ? 'selected' : null }}>
                                                Transaksi Jurnal Kas</option>
                                            <option value="Transaksi Jurnal Non Kas"
                                                {{ old('jns_akuntansi') == 'Transaksi Jurnal Non Kas' ? 'selected' : null }}>
                                                Transaksi Jurnal Non Kas</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6">
                        ...
                        <div class="card-body">
                            <div class="row ml-2">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="jns_akuntansi">Jenis Akuntansi :</label>
                                        <select name="jns_akuntansi" id="jns_akuntansi_edit" autocomplete="off"

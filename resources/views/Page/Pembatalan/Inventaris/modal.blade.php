...
<div class="modal fade" id="addModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-lg">
        <form id="quickForm" action="{{ url('pembatalan-inventaris') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="add" style="letter-spacing: 2px; font-weight: bold;">
                        Tambah Pengajuan Pembatalan Transaksi Inventaris
                    </h5>
                    ...
                    <div class="card card-outline card-primary">
                        <div class="card-body">
                            <div class="row ml-2">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="nomor_seri">No Seri :</label>
                                        <input type="text" name="nomor_seri" id="nomor_seri" required
                                            class="form-control input" placeholder="No Seri">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                        ...
                        <div class="card-body">
                            <div class="row ml-2">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="nomor_seri">No Seri :</label>
                                        <input type="text" name="nomor_seri" id="nomor_seri_edit" required
                                            class="form-control input" placeholder="No Seri">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="nama_barang">Nama Barang :</label>
                                        <input type="text" name="nama_barang" id="nama_barang_edit" required
                                            class="form-control input" placeholder="Nama Barang">
                                    </div>
                                </div>

...
{{-- modal add --}}
<div class="modal fade" id="addModal" data-bs-backdrop="static" data-bs-keyboard="false" aria-labelledby="addModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <form id="quickForm" action="{{ url('pemeliharaan-history') }}" method="post" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="card card-outline card-primary">
                        <div class="card-body">
                            <div class="row ml-2">
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <select name="kode_inventaris" id="kode_inventaris" autocomplete="off"
                                            class="input form-control">
                                            <option disabled selected>- Pilih Kode Inventaris -</option>
                                            @foreach ($barang as $item)
                                                <option value="{{ $item->kode_inventaris }}">
                                                    {{ $item->kode_inventaris }} &rarr; ({{ $item->kode_barang }})
                                                    &rarr; ({{ $item->posisi }})
                                                </option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="ml-2">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="detail_perbaikan">Detail Perbaikan :</label>
                ...
                <div class="card card-outline card-warning">
                    <div class="card-body">
                        ...
                        <div class="ml-2">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="detail_kerusakan_edit">Detail Kerusakan :</label>
                                    <input id="detail_kerusakan_edit" type="hidden" name="detail_kerusakan_edit"
                                        class="form-control input" placeholder="Detail Kendala" required>
                                    <trix-editor id="kerusakan" input="detail_kerusakan_edit"
                        ...
                        <div class="ml-2">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="detail_perbaikan_edit">Detail Perbaikan :</label>
                                    <input id="detail_perbaikan_edit" type="hidden" name="detail_perbaikan_edit"
                                        class="form-control input" placeholder="Detail Kendala" required>
                                    <trix-editor id="perbaikan" input="detail_perbaikan_edit"
                                        class="input"></trix-editor>
                                </div>
                            </div>
                        </div>

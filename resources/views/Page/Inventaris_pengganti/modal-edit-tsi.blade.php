        ...
        <div class="card-body">
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <textarea class="form-control input border-danger" name="catatan_tsi" id="catatan_tsi" cols="30"
                        rows="3" required placeholder="Catatan">{{ $inventarisPengganti->catatan_tsi }}</textarea>
                </div>
            </div>

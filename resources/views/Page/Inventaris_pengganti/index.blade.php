...
@section('konten')
    <div class="content-wrapper">
        ...
        {{-- Modal --}}
        @include('Page.Inventaris_pengganti.modal')
        {{-- @include('Page.Inventaris_pengganti.modal-edit') --}}
        {{-- end modal --}}
...
@section('script')
    <script src="{{ asset('script/Inventaris_pengganti/inventaris_index.js') }}"></script>
    <script src="{{ asset('script/Inventaris_pengganti/inventaris_input.js') }}"></script>
            ...
            $('.btnPrint').on('click', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.open('/inventaris-cetak/' + Id, '_blank');
                    }
                });
            });
        });

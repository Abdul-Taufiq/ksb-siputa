                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3 border-right bg-success">
                                        <div class="description-block">
                                            <h5 class="description-header">
                                                {{ $pemeliharaan->where('status_sdm', 'Approve')->count() }}
                                            </h5>
                                            <span class="description-text">APPROVED</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-3 border-right bg-warning">
                                        <div class="description-block">
                                            <h5 class="description-header">
                                                {{ $pemeliharaan->wherenull('status_sdm')->where('status_pincab', 'Approve')->count() }}
                                            </h5>
                                            <span class="description-text">NEED ACTION</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-3 bg-danger">
                                        <div class="description-block">
                                            <h5 class="description-header">
                                                {{ $pemeliharaan->where('status_sdm', 'Reject')->count() }}
                                            </h5>
                                            <span class="description-text">REJECTED</span>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3 border-right bg-success">
                                        <div class="description-block">
                                            <h5 class="description-header">
                                                {{ $bantuan_tsi->where('status_sdm', 'Approve')->count() }}
                                            </h5>
                                            <span class="description-text">APPROVED</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-3 border-right bg-warning">
                                        <div class="description-block">
                                            <h5 class="description-header">
                                                {{ $bantuan_tsi->wherenull('status_sdm')->where('status_pincab', 'Approve')->count() }}
                                            </h5>
                                            <span class="description-text">NEED ACTION</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-3 bg-danger">
                                        <div class="description-block">
                                            <h5 class="description-header">
                                                {{ $bantuan_tsi->where('status_sdm', 'Reject')->count() }}
                                            </h5>
                                            <span class="description-text">REJECTED</span>
                                        </div>
                                    </div>

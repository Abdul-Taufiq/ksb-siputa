                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3 border-right bg-success">
                                        <div class="description-block">
                                            <h5 class="description-header">
                                                {{ $Pefindo->where('id_cabang', $id_cabang)->where('status_pembukuan', 'Approve')->count() }}
                                            </h5>
                                    ...
                                    <div class="col-sm-3 border-right bg-warning">
                                        <div class="description-block">
                                            <h5 class="description-header">
                                                {{ $Pefindo->where('id_cabang', $id_cabang)->wherenull('status_pembukuan')->count() }}
                                            </h5>
                                    ...
                                    <div class="col-sm-3 bg-danger">
                                        <div class="description-block">
                                            <h5 class="description-header">
                                                {{ $Pefindo->where('id_cabang', $id_cabang)->where('status_pembukuan', 'Reject')->count() }}
                                            </h5>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3 border-right bg-success">
                                        <div class="description-block">
                                            <h5 class="description-header">
                                                {{ $Akuntansi->where('status_pembukuan', 'Approve')->count() }}
                                            </h5>
                                            <span class="description-text">APPROVED</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-3 bg-danger">
                                        <div class="description-block">
                                            <h5 class="description-header">
                                                {{ $Akuntansi->where('status_pembukuan', 'Reject')->count() }}
                                            </h5>
                                            <span class="description-text">REJECTED</span>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3 border-right bg-success">
                                        <div class="description-block">
                                            <h5 class="description-header">
                                                {{ $Antarbank->where('status_pembukuan', 'Approve')->count() }}
                                            </h5>
                                            <span class="description-text">APPROVED</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-3 bg-danger">
                                        <div class="description-block">
                                            <h5 class="description-header">
                                                {{ $Antarbank->where('status_pembukuan', 'Reject')->count() }}
                                            </h5>
                                            <span class="description-text">REJECTED</span>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3 border-right bg-success">
                                        <div class="description-block">
                                            <h5 class="description-header">
                                                {{ $Antarkantor->where('status_pembukuan', 'Approve')->count() }}
                                            </h5>
                                            <span class="description-text">APPROVED</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-3 bg-danger">
                                        <div class="description-block">
                                            <h5 class="description-header">
                                                {{ $Antarkantor->where('status_pembukuan', 'Reject')->count() }}
                                            </h5>
                                            <span class="description-text">REJECTED</span>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3 border-right bg-success">
                                        <div class="description-block">
                                            <h5 class="description-header">
                                                {{ $PDeposito->where('status_pembukuan', 'Approve')->count() }}
                                            </h5>
                                            <span class="description-text">APPROVED</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-3 bg-danger">
                                        <div class="description-block">
                                            <h5 class="description-header">
                                                {{ $PDeposito->where('status_pembukuan', 'Reject')->count() }}
                                            </h5>
                                            <span class="description-text">REJECTED</span>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3 border-right bg-success">
                                        <div class="description-block">
                                            <h5 class="description-header">
                                                {{ $PEcoll->where('status_pembukuan', 'Approve')->count() }}
                                            </h5>
                                            <span class="description-text">APPROVED</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-3 bg-danger">
                                        <div class="description-block">
                                            <h5 class="description-header">
                                                {{ $PEcoll->where('status_pembukuan', 'Reject')->count() }}
                                            </h5>
                                            <span class="description-text">REJECTED</span>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3 border-right bg-success">
                                        <div class="description-block">
                                            <h5 class="description-header">
                                                {{ $Inventaris->where('status_pembukuan', 'Approve')->count() }}
                                            </h5>
                                            <span class="description-text">APPROVED</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-3 bg-danger">
                                        <div class="description-block">
                                            <h5 class="description-header">
                                                {{ $Inventaris->where('status_pembukuan', 'Reject')->count() }}
                                            </h5>
                                            <span class="description-text">REJECTED</span>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3 border-right bg-success">
                                        <div class="description-block">
                                            <h5 class="description-header">
                                                {{ $Kredit->where('status_pembukuan', 'Approve')->count() }}
                                            </h5>
                                            <span class="description-text">APPROVED</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-3 bg-danger">
                                        <div class="description-block">
                                            <h5 class="description-header">
                                                {{ $Kredit->where('status_pembukuan', 'Reject')->count() }}
                                            </h5>
                                            <span class="description-text">REJECTED</span>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3 border-right bg-success">
                                        <div class="description-block">
                                            <h5 class="description-header">
                                                {{ $Tabungan->where('status_pembukuan', 'Approve')->count() }}
                                            </h5>
                                            <span class="description-text">APPROVED</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-3 bg-danger">
                                        <div class="description-block">
                                            <h5 class="description-header">
                                                {{ $Tabungan->where('status_pembukuan', 'Reject')->count() }}
                                            </h5>
                                            <span class="description-text">REJECTED</span>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3 border-right bg-success">
                                        <div class="description-block">
                                            <h5 class="description-header">
                                                {{ $Cif->where('status_pembukuan', 'Approve')->count() }}
                                            </h5>
                                            <span class="description-text">APPROVED</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-3 bg-danger">
                                        <div class="description-block">
                                            <h5 class="description-header">
                                                {{ $Cif->where('status_pembukuan', 'Reject')->count() }}
                                            </h5>
                                            <span class="description-text">REJECTED</span>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3 border-right bg-success">
                                        <div class="description-block">
                                            <h5 class="description-header">
                                                {{ $perKredit->where('status_pembukuan', 'Approve')->count() }}
                                            </h5>
                                            <span class="description-text">APPROVED</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-3 bg-danger">
                                        <div class="description-block">
                                            <h5 class="description-header">
                                                {{ $perKredit->where('status_pembukuan', 'Reject')->count() }}
                                            </h5>
                                            <span class="description-text">REJECTED</span>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3 border-right bg-success">
                                        <div class="description-block">
                                            <h5 class="description-header">
                                                {{ $perDeposito->where('status_pembukuan', 'Approve')->count() }}
                                            </h5>
                                            <span class="description-text">APPROVED</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-3 bg-danger">
                                        <div class="description-block">
                                            <h5 class="description-header">
                                                {{ $perDeposito->where('status_pembukuan', 'Reject')->count() }}
                                            </h5>
                                            <span class="description-text">REJECTED</span>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3 border-right bg-success">
                                        <div class="description-block">
                                            <h5 class="description-header">
                                                {{ $inv_baru->where('status_pembukuan', 'Approve')->count() }}
                                            </h5>
                                            <span class="description-text">APPROVED</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-3 bg-danger">
                                        <div class="description-block">
                                            <h5 class="description-header">
                                                {{ $inv_baru->where('status_pembukuan', 'Reject')->count() }}
                                            </h5>
                                            <span class="description-text">REJECTED</span>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3 border-right bg-success">
                                        <div class="description-block">
                                            <h5 class="description-header">
                                                {{ $inv_pengganti->where('status_pembukuan', 'Approve')->count() }}
                                            </h5>
                                            <span class="description-text">APPROVED</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-3 bg-danger">
                                        <div class="description-block">
                                            <h5 class="description-header">
                                                {{ $inv_pengganti->where('status_pembukuan', 'Reject')->count() }}
                                            </h5>
                                            <span class="description-text">REJECTED</span>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3 border-right bg-success">
                                        <div class="description-block">
                                            <h5 class="description-header">
                                                {{ $inv_dijual->where('status_pembukuan', 'Approve')->count() }}
                                            </h5>
                                            <span class="description-text">APPROVED</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-3 border-right bg-warning">
                                        <div class="description-block">
                                            <h5 class="description-header">
                                                {{ $inv_dijual->wherenull('status_pembukuan')->where('status_pincab', 'Approve')->count() }}
                                            </h5>
                                            <span class="description-text">NEED ACTION</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-3 bg-danger">
                                        <div class="description-block">
                                            <h5 class="description-header">
                                                {{ $inv_dijual->where('status_pembukuan', 'Reject')->count() }}
                                            </h5>
                                            <span class="description-text">REJECTED</span>
                                        </div>
                                    </div>
...
<section class="content isi_konten">
    <div class="container-fluid">
        <div class="card card-outline card-primary">
            <div class="card-header">
                <h4 class="card-title">DATA BANTUAN TSI</h4>
                <div class="card-tools">
                    <button type="button" class="btn btn-tool" data-card-widget="collapse"><i
                            class="fas fa-minus"></i>
                    </button>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3 border-right bg-success">
                                        <div class="description-block">
                                            <h5 class="description-header">
                                                {{ $pemeliharaan->where('status_pembukuan', 'Approve')->count() }}
                                            </h5>
                                            <span class="description-text">APPROVED</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-3 border-right bg-warning">
                                        <div class="description-block">
                                            <h5 class="description-header">
                                                {{ $pemeliharaan->wherenull('status_pembukuan')->where('status_pincab', 'Approve')->count() }}
                                            </h5>
                                            <span class="description-text">NEED ACTION</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-3 bg-danger">
                                        <div class="description-block">
                                            <h5 class="description-header">
                                                {{ $pemeliharaan->where('status_pembukuan', 'Reject')->count() }}
                                            </h5>
                                            <span class="description-text">REJECTED</span>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3 border-right bg-success">
                                        <div class="description-block">
                                            <h5 class="description-header">
                                                {{ $bantuan_tsi->where('status_pembukuan', 'Approve')->count() }}
                                            </h5>
                                            <span class="description-text">APPROVED</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-3 border-right bg-warning">
                                        <div class="description-block">
                                            <h5 class="description-header">
                                                {{ $bantuan_tsi->wherenull('status_pembukuan')->where('status_pincab', 'Approve')->count() }}
                                            </h5>
                                            <span class="description-text">NEED ACTION</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-3 bg-danger">
                                        <div class="description-block">
                                            <h5 class="description-header">
                                                {{ $bantuan_tsi->where('status_pembukuan', 'Reject')->count() }}
                                            </h5>
                                            <span class="description-text">REJECTED</span>
                                        </div>
                                    </div>

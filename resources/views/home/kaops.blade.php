                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3 border-right bg-success">
                                        <div class="description-block">
                                            <h5 class="description-header">
                                                {{ $pemeliharaan->where('id_cabang', $id_cabang)->where('status_akhir', 'Selesai')->count() }}
                                            </h5>
                                            <span class="description-text">APPROVED</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-3 border-right bg-warning">
                                        <div class="description-block">
                                            <h5 class="description-header">
                                                {{ $pemeliharaan->where('id_cabang', $id_cabang)->where('status_akhir', 'Proses')->count() }}
                                            </h5>
                                            <span class="description-text">PROCCESS</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-3 bg-danger">
                                        <div class="description-block">
                                            <h5 class="description-header">
                                                {{ $pemeliharaan->where('id_cabang', $id_cabang)->where('status_akhir', 'Ditolak')->count() }}
                                            </h5>
                                            <span class="description-text">REJECTED</span>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3 border-right bg-success">
                                        <div class="description-block">
                                            <h5 class="description-header">
                                                {{ $bantuan_tsi->where('id_cabang', $id_cabang)->where('status_akhir', 'Selesai')->count() }}
                                            </h5>
                                            <span class="description-text">APPROVED</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-3 border-right bg-warning">
                                        <div class="description-block">
                                            <h5 class="description-header">
                                                {{ $bantuan_tsi->where('id_cabang', $id_cabang)->where('status_akhir', 'Proses')->count() }}
                                            </h5>
                                            <span class="description-text">PROCCESS</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-3 bg-danger">
                                        <div class="description-block">
                                            <h5 class="description-header">
                                                {{ $bantuan_tsi->where('id_cabang', $id_cabang)->where('status_akhir', 'Ditolak')->count() }}
                                            </h5>
                                            <span class="description-text">REJECTED</span>
                                        </div>
                                    </div>

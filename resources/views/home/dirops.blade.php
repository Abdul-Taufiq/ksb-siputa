                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3 border-right bg-success">
                                        <div class="description-block">
                                            <h5 class="description-header">
                                                {{ $inv_baru->where('status_dirops', 'Approve')->count() }}
                                            </h5>
                                            <span class="description-text">APPROVED</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-3 bg-danger">
                                        <div class="description-block">
                                            <h5 class="description-header">
                                                {{ $inv_baru->where('status_dirops', 'Reject')->count() }}
                                            </h5>
                                            <span class="description-text">REJECTED</span>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3 border-right bg-success">
                                        <div class="description-block">
                                            <h5 class="description-header">
                                                {{ $inv_pengganti->where('status_dirops', 'Approve')->count() }}
                                            </h5>
                                            <span class="description-text">APPROVED</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-3 bg-danger">
                                        <div class="description-block">
                                            <h5 class="description-header">
                                                {{ $inv_pengganti->where('status_dirops', 'Reject')->count() }}
                                            </h5>
                                            <span class="description-text">REJECTED</span>
                                        </div>
                                    </div>

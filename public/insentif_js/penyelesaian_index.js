    ...
    $(document).ready(function () {
        ...
        $("#table_index").DataTable({
            ...
            columns: [
                ...
                {
                    data: "komposisi_insentif",
                    name: "komposisi_insentif",
                },
...
$(document).ready(function () {
    $("body").on("click", ".detail_data", function () {
        ...
        $("#frameDetail").attr("src", "/insentif/penyelesaian/" + Id); //merubah link frame
...
$(document).ready(function () {
    $("body").on("click", ".approve", function () {
        ...
        var formAction = "/insentif/get-penyelesaian-status/" + id + "/Approve";
...
$(document).ready(function () {
    $("body").on("click", ".reject", function () {
        ...
        // Ubah action form untuk menyertakan ID
        var formAction = "/insentif/get-penyelesaian-status/" + id + "/Reject";

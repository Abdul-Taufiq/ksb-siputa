            ...
            columns: [
...

                {
                    ...
                    render: function (data, type, row) {
                        return (
                            moment(data.tgl_awal)
                                .locale("id")
                                .format("DD/MM/YYYY") +
                            " s/d " +
                            moment(data.tgl_akhir)
                                .locale("id")
                                .format("DD/MM/YYYY")
                        );
                    },
...
$(document).ready(function () {
    $("body").on("click", ".detail_data", function () {
        ...
        $("#frameDetail").attr("src", "/insentif/surtug/" + Id); //merubah link frame
...
$(document).ready(function () {
    $("body").on("click", ".approve", function () {
        ...
        var formAction = "/insentif/get-status/" + id + "/Approve";
...
$(document).ready(function () {
    $("body").on("click", ".reject", function () {
        ...
        // Ubah action form untuk menyertakan ID
        var formAction = "/insentif/get-status/" + id + "/Reject";

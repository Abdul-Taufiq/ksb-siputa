...
$(document).ready(function () {
    $("body").on("click", ".detail_data", function () {
        ...
        $("#frameDetail").attr("src", "/perubahan-deposito/" + Id); //merubah link frame
...
//  =
var nominal_p = document.getElementById("nominal_p");
nominal_p.addEventListener("input", function (e) {
    this.value = formatRupiah(this.value, "Rp. ");
});
var nominal_s = document.getElementById("nominal_s");
nominal_s.addEventListener("input", function (e) {
    this.value = formatRupiah(this.value, "Rp. ");
});
var nominal_p_edit = document.getElementById("nominal_p_edit");
nominal_p_edit.addEventListener("input", function (e) {
    this.value = formatRupiah(this.value, "Rp. ");
});
var nominal_s_edit = document.getElementById("nominal_s_edit");
nominal_s_edit.addEventListener("input", function (e) {
    this.value = formatRupiah(this.value, "Rp. ");
});
...
// pembatasan input
$("#jns_deposito").on("change", function () {
    var selectopt = $(this).val();
    var selain = document.getElementById("selain_sk");
    var agunan = document.getElementById("data_sk");
    var lain = document.getElementById("keterangan_jns_deposito_head");

    if (selectopt == "Valuta dan Suku Bunga") {
        selain.classList.add("d-none");
        agunan.classList.remove("d-none");
        lain.classList.add("d-none");
    } else if (selectopt == "Jangka Waktu") {
...
$(document).ready(function () {
    $("body").on("click", ".edit", function () {
        ...
        $("#jns_deposito_edit").on("change", function () {
            var selectopt = $(this).val();
            var selain = document.getElementById("selain_sk_edit");
            var agunan = document.getElementById("data_sk_edit");
            var lain = document.getElementById(
                "keterangan_jns_deposito_edit_head"
            );
        ...
        $.ajax({
            type: "GET",
            url: "/perubahan-deposito/" + Id + "/edit",
            success: function (response) {
                console.log("Rz wuzz here");
                $("#jns_deposito_edit").val(response.data.jns_deposito);
                ...
                if (response.data.jns_deposito == "Valuta dan Suku Bunga") {
                    selain.classList.add("d-none");
                    agunan.classList.remove("d-none");
                    lain.classList.add("d-none");
                } else if (response.data.jns_deposito == "Jangka Waktu") {
                    selain.classList.remove("d-none");
                    agunan.classList.add("d-none");
                    lain.classList.add("d-none");
                } else {
                    ...
                    selain.classList.remove("d-none");
                    agunan.classList.add("d-none");
                    $("#jns_deposito_edit").val("Lainnya");
                    $("#keterangan_jns_deposito_edit").val(
                        response.data.jns_deposito
                    );
                }

                // link formnya
                $("#editForm").attr("action", "/perubahan-deposito/" + Id);
            },
        });
    });
});
...
$(document).ready(function () {
    $("body").on("click", ".approve", function () {
        ...
        var formAction = "/perubahan-deposito-approve/" + idKredit;
...
$(document).ready(function () {
    $("body").on("click", ".reject", function () {
        ...
        // Ubah action form untuk menyertakan ID
        var formAction = "/perubahan-deposito-reject/" + idKredit;

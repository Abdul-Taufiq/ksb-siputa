...
$(document).ready(function () {
    $("body").on("click", ".detail_data", function () {
        ...
        $("#frameDetail").attr("src", "/pefindo-reset/" + Id); //merubah link frame
    ...
    $("body").on("click", ".edit", function () {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                // link formnya
                $("#editForm").attr("action", "/pefindo-reset/" + Id);
            },
        });
    });
});
...
$(document).ready(function () {
    $("body").on("click", ".approve", function () {
        ...
        var formAction = "/pefindo-reset-approve/" + idKredit;
...
$(document).ready(function () {
    $("body").on("click", ".reject", function () {
        ...
        // Ubah action form untuk menyertakan ID
        var formAction = "/pefindo-reset-reject/" + idKredit;

...
$(document).ready(function () {
    $("body").on("click", ".detail_data", function () {
        ...
        $("#frameDetail").attr("src", "/pefindo-pengajuan/" + Id); //merubah link frame
    ...
    $("body").on("click", ".edit", function () {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                // link formnya
                $("#editForm").attr("action", "/pefindo-pengajuan/" + Id);
            },
        });
    });
});
...
$(document).ready(function () {
    $("body").on("click", ".approve", function () {
        ...
        var formAction = "/pefindo-pengajuan-approve/" + idKredit;
...
$(document).ready(function () {
    $("body").on("click", ".reject", function () {
        ...
        // Ubah action form untuk menyertakan ID
        var formAction = "/pefindo-pengajuan-reject/" + idKredit;

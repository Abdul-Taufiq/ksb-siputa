...
$(document).ready(function () {
    $("body").on("click", ".detail_data", function () {
        ...
        $("#frameDetail").attr("src", "/tsi-barang-elektro/" + Id); //merubah link frame
...
$(document).ready(function () {
    $("body").on("click", ".edit", function () {
        ...
        $.ajax({
            type: "GET",
            url: "/tsi-barang-elektro/" + Id + "/edit",
            success: function (response) {
                ...
                $("#kode_barang_edit").val(response.data.kode_barang);
                $("#jns_barang_edit").val(response.data.jns_barang);
                ...
                $("#spek").val(response.data.speksifikasi);
                $("#tgl_pembelian_edit").val(response.data.tgl_pembelian);
                // $("#nama_edit").val(response.data.nama);

                // link formnya
                $("#editForm").attr("action", "/tsi-barang-elektro/" + Id);
            },
        });
    });
});
...
$(document).ready(function () {
    $("body").on("click", ".approve", function () {
        ...
        var formAction = "/tsi-barang-elektro-approve/" + idKredit;
...
$(document).ready(function () {
    $("body").on("click", ".reject", function () {
        ...
        // Ubah action form untuk menyertakan ID
        var formAction = "/tsi-barang-elektro-reject/" + idKredit;

...
$(document).ready(function () {
    $("body").on("click", ".detail_data", function () {
        ...
        $("#frameDetail").attr("src", "/user-siadit/" + Id); //merubah link frame
    ...
    $("body").on("click", ".edit", function () {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                // link formnya
                $("#editForm").attr("action", "/user-siadit/" + Id);
            },
        });
    });
});
...
$(document).ready(function () {
    $("body").on("click", ".approve", function () {
        ...
        var formAction = "/siadit-user-approve/" + idKredit;
...
$(document).ready(function () {
    $("body").on("click", ".reject", function () {
        ...
        // Ubah action form untuk menyertakan ID
        var formAction = "/siadit-user-reject/" + idKredit;

...
$(document).ready(function () {
    $("body").on("click", ".detail_data", function () {
        ...
        $("#frameDetail").attr("src", "/pembatalan-ecoll/" + Id); //merubah link frame
    ...
    $("body").on("click", ".edit", function () {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                // link formnya
                $("#editForm").attr("action", "/pembatalan-ecoll/" + Id);
            },
        });
    });
});
...
$(document).ready(function () {
    $("body").on("click", ".approve", function () {
        ...
        var formAction = "/pembatalan-ecoll-approve/" + idKredit;
...
$(document).ready(function () {
    $("body").on("click", ".reject", function () {
        ...
        // Ubah action form untuk menyertakan ID
        var formAction = "/pembatalan-ecoll-reject/" + idKredit;

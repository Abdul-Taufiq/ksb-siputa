...
$(document).ready(function () {
    $("body").on("click", ".detail_data", function () {
        ...
        $("#frameDetail").attr("src", "/pembatalan-deposito/" + Id); //merubah link frame
...
$(document).ready(function () {
    $("body").on("click", ".edit", function () {
        ...
        $.ajax({
            type: "GET",
            url: "/pembatalan-deposito/" + Id + "/edit",
            success: function (response) {
                ...
                // link formnya
                $("#editForm").attr("action", "/pembatalan-deposito/" + Id);
            },
        });
    });
});
...
$(document).ready(function () {
    $("body").on("click", ".approve", function () {
        ...
        var formAction = "/pembatalan-deposito-approve/" + idKredit;
...
$(document).ready(function () {
    $("body").on("click", ".reject", function () {
        ...
        // Ubah action form untuk menyertakan ID
        var formAction = "/pembatalan-deposito-reject/" + idKredit;

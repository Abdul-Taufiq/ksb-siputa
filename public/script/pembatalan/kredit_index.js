...
$(document).ready(function () {
    $("body").on("click", ".detail_data", function () {
        ...
        $("#frameDetail").attr("src", "/pembatalan-kredit/" + Id); //merubah link frame
...
$("#jns_kredit").on("change", function () {
    ...
    var jns_kredit_head = document.getElementById("keterangan_jns_kredit_head");
    var user_head = document.getElementById("user_head");
    var jns_kredit = $("#keterangan_jns_kredit");
    var user = $("#user");

    if (selectopt == "Transaksi Manual Kredit") {
        jns_kredit_head.classList.add("d-none");
        user_head.classList.remove("d-none");
        user.prop("required", true);
    }
    //
    else if (selectopt == "Transaksi Autodebet Kredit") {
        jns_kredit_head.classList.add("d-none");
        user_head.classList.add("d-none");
        user.prop("required", false);
        jns_kredit.prop("required", false);
    }
    //
    else {
        jns_kredit_head.classList.remove("d-none");
        user_head.classList.remove("d-none");
        jns_kredit.prop("required", true);
        user.prop("required", true);
    }
});
...
$(document).ready(function () {
    $("body").on("click", ".edit", function () {
        ...
        $("#jns_kredit_edit").on("change", function () {
            var selectopt = $(this).val();
            var jns_kredit_head = document.getElementById(
                "keterangan_jns_kredit_head_edit"
            );
            var jns_kredit = $("#keterangan_jns_kredit_edit");
            var user_head = document.getElementById("user_head_edit");
            var user = $("#user_edit");
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                // kondisi untuk select opt
                if (response.data.jns_kredit == "Transaksi Manual Kredit") {
                    jns_kredit_head.classList.add("d-none");
                    user_head.classList.remove("d-none");
                    user.prop("required", true);
                } else if (
                    response.data.jns_kredit == "Transaksi Autodebet Kredit"
                ) {
                    jns_kredit_head.classList.add("d-none");
                    user_head.classList.add("d-none");
                    user.prop("required", false);
                    ...
                    response.data.jns_kredit != "Transaksi Autodebet Kredit" &&
                    response.data.jns_kredit != "Transaksi Manual Kredit"
                ) {
                    jns_kredit_head.classList.remove("d-none");
                    user_head.classList.remove("d-none");
                    jns_kredit.prop("required", true);
                ...
                // link formnya
                $("#editForm").attr("action", "/pembatalan-kredit/" + Id);
            },
        });
    });
});
...
$(document).ready(function () {
    $("body").on("click", ".approve", function () {
        ...
        var formAction = "/pembatalan-kredit-approve/" + idKredit;
...
$(document).ready(function () {
    $("body").on("click", ".reject", function () {
        ...
        // Ubah action form untuk menyertakan ID
        var formAction = "/pembatalan-kredit-reject/" + idKredit;

...
$(document).ready(function () {
    $("body").on("click", ".detail_data", function () {
        ...
        $("#frameDetail").attr("src", "/pembatalan-inventaris/" + Id); //merubah link frame
...
$(document).ready(function () {
    $("body").on("click", ".edit", function () {
        ...
        $.ajax({
            type: "GET",
            url: "/pembatalan-inventaris/" + Id + "/edit",
            success: function (response) {
                console.log("Rz wuzz here");
                $("#id_transaksi_edit").val(response.data.id_transaksi);
                $("#nomor_seri_edit").val(response.data.nomor_seri);
                ...
                // link formnya
                $("#editForm").attr("action", "/pembatalan-inventaris/" + Id);
            },
        });
    });
});
...
$(document).ready(function () {
    $("body").on("click", ".approve", function () {
        ...
        var formAction = "/pembatalan-inventaris-approve/" + idKredit;
...
$(document).ready(function () {
    $("body").on("click", ".reject", function () {
        ...
        // Ubah action form untuk menyertakan ID
        var formAction = "/pembatalan-inventaris-reject/" + idKredit;

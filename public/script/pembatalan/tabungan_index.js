...
$(document).ready(function () {
    $("body").on("click", ".detail_data", function () {
        ...
        $("#frameDetail").attr("src", "/pembatalan-tabungan/" + Id); //merubah link frame
...
$(document).ready(function () {
    $("body").on("click", ".edit", function () {
        ...
        $.ajax({
            type: "GET",
            url: "/pembatalan-tabungan/" + Id + "/edit",
            success: function (response) {
                ...
                // link formnya
                $("#editForm").attr("action", "/pembatalan-tabungan/" + Id);
            },
        });
    });
});
...
$(document).ready(function () {
    $("body").on("click", ".approve", function () {
        ...
        var formAction = "/pembatalan-tabungan-approve/" + idKredit;
...
$(document).ready(function () {
    $("body").on("click", ".reject", function () {
        ...
        // Ubah action form untuk menyertakan ID
        var formAction = "/pembatalan-tabungan-reject/" + idKredit;

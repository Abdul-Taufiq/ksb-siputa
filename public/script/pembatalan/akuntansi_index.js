...
$(document).ready(function () {
    $("body").on("click", ".detail_data", function () {
        ...
        $("#frameDetail").attr("src", "/pembatalan-akuntansi/" + Id); //merubah link frame
...
$(document).ready(function () {
    $("body").on("click", ".edit", function () {
        ...
        $.ajax({
            type: "GET",
            url: "/pembatalan-akuntansi/" + Id + "/edit",
            success: function (response) {
                console.log("Rz wuzz here");
                $("#jns_akuntansi_edit").val(response.data.jns_akuntansi);
                ...
                // link formnya
                $("#editForm").attr("action", "/pembatalan-akuntansi/" + Id);
            },
        });
    });
});
...
$(document).ready(function () {
    $("body").on("click", ".approve", function () {
        ...
        var formAction = "/pembatalan-akuntansi-approve/" + idKredit;
...
$(document).ready(function () {
    $("body").on("click", ".reject", function () {
        ...
        // Ubah action form untuk menyertakan ID
        var formAction = "/pembatalan-akuntansi-reject/" + idKredit;

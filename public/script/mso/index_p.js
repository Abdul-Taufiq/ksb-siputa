...
$(document).ready(function () {
    $("body").on("click", ".detail_data", function () {
        ...
        $("#frameDetail").attr("src", "/mso-pengajuan/" + Id); //merubah link frame
    ...
    $("body").on("click", ".edit", function () {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $("#tgl_awal_edit").val(response.data.tgl_awal);
                $("#tgl_akhir_edit").val(response.data.tgl_akhir);
                console.log(response.data.nik);

                // link formnya
                $("#editForm").attr("action", "/mso-pengajuan/" + Id);
            },
        });
    });
});
...
$(document).ready(function () {
    $("body").on("click", ".approve", function () {
        ...
        var formAction = "/mso-pengajuan-approve/" + idKredit;
...
$(document).ready(function () {
    $("body").on("click", ".reject", function () {
        ...
        // Ubah action form untuk menyertakan ID
        var formAction = "/mso-pengajuan-reject/" + idKredit;

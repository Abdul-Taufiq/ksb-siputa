...
$(document).ready(function () {
    $("body").on("click", ".detail_data", function () {
        ...
        $("#frameDetail").attr("src", "/user-email-pengajuan/" + Id); //merubah link frame
...
$(document).ready(function () {
    $("body").on("click", ".edit", function () {
        ...
        $.ajax({
            type: "GET",
            url: "/user-email-pengajuan/" + Id + "/edit",
            success: function (response) {
                ...
                // link formnya
                $("#editForm").attr("action", "/user-email-pengajuan/" + Id);
            },
        });
    });
});
...
$(document).ready(function () {
    $("body").on("click", ".approve", function () {
        ...
        var formAction = "/email-approve/" + idKredit;
...
$(document).ready(function () {
    $("body").on("click", ".reject", function () {
        ...
        // Ubah action form untuk menyertakan ID
        var formAction = "/email-reject/" + idKredit;
